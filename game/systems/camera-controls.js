...
const OrbitalControls = ({
  ...
  return (entities, { touches }) => {
    ...
    if (camera && moves.length > 1) {
      ...
      rotateAroundPoint(camera, camera.target, { thetaY: deltaX * yawSpeed, thetaX: deltaY * pitchSpeed })

      // camera.position.x =
      //   x * Math.cos(-locationX * yawSpeed) +
      //   z * Math.sin(-locationX * yawSpeed);
      // camera.position.z =
      //   z * Math.cos(-locationX * yawSpeed) -
      //   x * Math.sin(-locationX * yawSpeed);
      ...
      //   .clone()
      //   .sub(
      //     new Vector2(finger1.delta.locationX, finger1.delta.locationY)
      //   );
      ...
      //   .clone()
      //   .sub(
      //     new Vector2(finger2.delta.locationX, finger2.delta.locationY)
      //   );
      ...
      //   const zoomFactor =
      //     currentDistance > previousDistance ? 1 - zoomSpeed : 1 + zoomSpeed;
